...
but you can see from the outside that after only a few units a staircase going down tempts you. Knowing there is nothing else to do you enter the room.
...
it does not barge. You then grab the torch attached to the scone to your right and descend down the stairway.
"""
...
which seems to be more like a complete dungeon rather than a room to some weird abandoned structure. After what felt like much longer than it really was,
