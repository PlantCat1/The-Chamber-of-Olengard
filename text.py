...
text10 = """You slowly move to the chest to the right trying your best not to wake the goblin. After being in front of the chest you look to your left to check on the guard,
who is still in deep sleep. You look at the shiny gold lock and can see that it's unlocked and ready to be opened, if you so desire."""

text11 = """You take another look at the chest, and then back at the guard and decide to open it up and see what’s inside. You slide up the top of the chest,
and see a bow and some arrows and nothing else. The weapon looks pretty average and seems to be made recently and is probably used by the guard.
